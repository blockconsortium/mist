...
gulp.task('upload-binaries', (cb) => {
    ...
    got(`https://api.github.com/repos/expanse-org/mist/releases?access_token=${GITHUB_TOKEN}`, { json: true })
        ...
        if (draft.draft === true) {
            ...
            .then(() => {
                ...
                if (draft.body && checksums) {
                    ...
                    got.patch(`https://api.github.com/repos/expanse-org/mist/releases/${draft.id}?access_token=${GITHUB_TOKEN}`, {
                        body: JSON.stringify({
                            tag_name: `v${version}`,
